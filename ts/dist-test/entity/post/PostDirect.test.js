...
(0, node_test_1.describe)('PostDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PrankShowSDK({
...
function liveScenariosActive() { return false && process.env.PRANK_SHOW_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PrankShowSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PRANK_SHOW_TEST_POST_ENTID'];
    ...
    const client = new __1.PrankShowSDK({
        base: 'http://localhost:8080',
