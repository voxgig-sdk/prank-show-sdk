...
function envOverride(m) {
    if ('TRUE' === process.env.PRANK_SHOW_TEST_LIVE ||
        'TRUE' === process.env.PRANK_SHOW_TEST_OVERRIDE) {
    ...
    m.PRANK_SHOW_TEST_EXPLAIN = process.env.PRANK_SHOW_TEST_EXPLAIN || m.PRANK_SHOW_TEST_EXPLAIN;
    return m;
}
