# PrankShow TypeScript SDK



The TypeScript SDK for the PrankShow API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/prank-show-sdk/releases](https://github.com/voxgig-sdk/prank-show-sdk/releases)
...
```ts
const posts = await client.Post().list({ page: 1 })
...
```ts
const client = PrankShowSDK.test()
...
| `tester(testopts?, sdkopts?)` | `PrankShowSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `PrankShowSDK.test(testopts?, sdkopts?)` | `PrankShowSDK` | Create a test-mode client. |
...
| `client` | `client(): PrankShowSDK` | Return the parent SDK client. |
...
prank-show/
├── src/
│   ├── PrankShowSDK.ts        # Main SDK class
