# PrankShow Golang SDK



The Golang SDK for the PrankShow API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/prank-show-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/prank-show-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/prank-show-sdk/go=../prank-show-sdk/go
```
...
import (
    "fmt"
    sdk "github.com/voxgig-sdk/prank-show-sdk/go"
)
...
client := sdk.NewPrankShowSDK(map[string]any{
...
```go
func NewPrankShowSDK(options map[string]any) *PrankShowSDK
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *PrankShowSDK
```

Creates a test-mode client with mock transport. Both arguments may be `nil`.

### PrankShowSDK methods
...
| `Post` | `(data map[string]any) PrankShowEntity` | Create a Post entity instance. |

### Entity interface (PrankShowEntity)

All entities implement the `PrankShowEntity` interface.
...
```
github.com/voxgig-sdk/prank-show-sdk/go/
├── prank-show.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/prank-show-sdk/go`) re-exports everything needed
