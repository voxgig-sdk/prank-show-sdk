# PrankShow Golang SDK Reference

Complete API reference for the PrankShow Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *PrankShowSDK`
...
#### `Post(data map[string]any) PrankShowEntity`
