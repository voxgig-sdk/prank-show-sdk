...
Prank Show API client, generated from the OpenAPI spec.

The Prank Show API provides a collection of fresh pranks daily along with a complete archive spanning ten years.

Learn more about Prank Show API at [github.com/l0v3m0n3y/prankshow](https://github.com/l0v3m0n3y/prankshow).

This is an unofficial SDK for the Prank Show public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
const items = await client.Post().list({ page: 1 })
```
...
| Python | `voxgig-sdk-prank-show-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/prank-show-sdk/tags) |
| PHP | `voxgig-sdk/prank-show-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/prank-show-sdk/tags) |
| Golang | `github.com/voxgig-sdk/prank-show-sdk/go` | `go get github.com/voxgig-sdk/prank-show-sdk/go@latest` |
| Ruby | `voxgig-sdk-prank-show-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/prank-show-sdk/tags) |
| Lua | `voxgig-sdk-prank-show-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/prank-show-sdk/tags) |
...
```bash
cd go-mcp && go build -o prank-show-mcp .
```
...
```json
{
  "mcpServers": {
    "prank-show": {
      "command": "/abs/path/to/prank-show-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **Post** | The Post entity (list). | `/posts/get` |
...
```go
import sdk "github.com/voxgig-sdk/prank-show-sdk/go"
...
- Upstream API: [https://github.com/l0v3m0n3y/prankshow](https://github.com/l0v3m0n3y/prankshow)
...
Generated from the Prank Show API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
