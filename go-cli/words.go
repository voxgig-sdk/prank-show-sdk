...
func registerSDKWords(r *eng.Registry, client *sdk.PrankShowSDK) {
...
func runOp(client *sdk.PrankShowSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
