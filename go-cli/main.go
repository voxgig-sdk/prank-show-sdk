// Command PrankShow-cli is a CLI + REPL for the PrankShow SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      PRANK_SHOW_APIKEY (api key), PRANK_SHOW_BASE (base url override)")
