...
The Lua SDK for the PrankShow API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/prank-show-sdk/releases)),
...
The main module (`prank-show_sdk`) exports the SDK constructor
