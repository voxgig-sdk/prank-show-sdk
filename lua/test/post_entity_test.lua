...
describe("PostEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set PRANK_SHOW_TEST_POST_ENTID JSON to run live")
      return
    end
...
function post_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("PRANK_SHOW_TEST_POST_ENTID")
  ...
  if env["PRANK_SHOW_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["PRANK_SHOW_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
