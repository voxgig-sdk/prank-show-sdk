# PrankShow Python SDK Reference

Complete API reference for the PrankShow Python SDK.
...
#### `PrankShowSDK.test(testopts=None, sdkopts=None)`
...
```python
results = client.Post().list({"page": 1})
for post in results:
    print(post)
```
