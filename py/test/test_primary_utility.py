...
_runner = makeRunner(TEST_JSON_FILE, PrankShowSDK.test(None, None))
...
def _auth_credential():
    ...
    ctx.spec = PrankShowSpec({"headers": {}, "query": {}})
    try:
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PrankShowSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PrankShowSDK.test(None, setup.get('a') or {})
