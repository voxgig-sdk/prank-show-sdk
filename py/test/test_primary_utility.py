...
from prankshow_sdk.utility.voxgig_struct import voxgig_struct as vs
from prankshow_sdk import PrankShowSDK
from prankshow_sdk.core.spec import PrankShowSpec
from prankshow_sdk.core.result import PrankShowResult
from prankshow_sdk.core.response import PrankShowResponse
from prankshow_sdk.core.operation import PrankShowOperation
from prankshow_sdk.core.error import PrankShowError
from prankshow_sdk.core import helpers
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return PrankShowError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = PrankShowSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = PrankShowSDK.test(None, None)
        ...
        class TestInitFeature(PrankShowBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(PrankShowBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = PrankShowSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PrankShowSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PrankShowSDK.test(None, setup_opts)
