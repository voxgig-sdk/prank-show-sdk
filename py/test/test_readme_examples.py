# PrankShow SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PrankShowSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PrankShowSDK(...) and PrankShowSDK.test(...) become
#      PrankShowSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "prankshow_sdk"
_SDK_CLASS = "PrankShowSDK"
