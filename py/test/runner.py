...
class PrankShowTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PrankShowTestRunner.getenv("PRANKSHOW_TEST_LIVE")
        override = PrankShowTestRunner.getenv("PRANKSHOW_TEST_OVERRIDE")
        ...
        explain = PrankShowTestRunner.getenv("PRANKSHOW_TEST_EXPLAIN")
