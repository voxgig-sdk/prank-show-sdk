...
from prankshow_sdk.utility import register

# Load features
from prankshow_sdk.feature.base_feature import PrankShowBaseFeature
from prankshow_sdk.features import _has_feature, _make_feature
...
class PrankShowSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = PrankShowUtility()
        self._utility = utility

        from prankshow_sdk.config import shared_config
    ...
    def get_utility(self):
        return PrankShowUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PrankShowSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Post(self, data=None) -> "PostEntity":
        ...
        from prankshow_sdk.entity.post_entity import PostEntity
        return PostEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "PrankShowSDK":
        if sdkopts is None:
            sdkopts = {}
