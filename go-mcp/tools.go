...
func registerTools(server *mcp.Server, client *sdk.PrankShowSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "prank-show_list",
		Description: "List records from PrankShow. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "prank-show_load",
		Description: "Load a single record from PrankShow. " +
...
func runOp(client *sdk.PrankShowSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PrankShowSDK, name string) (sdk.PrankShowEntity, error) {
