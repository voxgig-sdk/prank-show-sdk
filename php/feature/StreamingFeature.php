...
// PrankShow SDK streaming feature
...
class PrankShowStreamingFeature extends PrankShowBaseFeature
{
    ...
    private function _iterate(PrankShowResult $result): \Generator
    {
    ...
    private function _streamable(PrankShowContext $ctx): bool
    {
