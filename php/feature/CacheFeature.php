...
class PrankShowCacheFeature extends PrankShowBaseFeature
{
    ...
    private function _through(PrankShowContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
