...
The PHP SDK for the PrankShow API — an entity-oriented client using PHP conventions.
...
```php
<?php
require_once 'prankshow_sdk.php';

$client = new PrankShowSDK();
```
...
```php
require_once 'prankshow_sdk.php';
$client = new PrankShowSDK($options);
```
...
```
php/
├── prankshow_sdk.php          -- Main SDK class
...
The main class (`prankshow_sdk.php`) exports the SDK class
