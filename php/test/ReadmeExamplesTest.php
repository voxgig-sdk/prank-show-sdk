...
// PrankShow SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PrankShowSDK::test)
...
{
    private const SDK_CLASS = 'PrankShowSDK';
    ...
    private const SDK_BASE = 'prankshow_sdk';
