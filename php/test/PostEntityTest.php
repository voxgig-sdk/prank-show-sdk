...
class PostEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $cfg = PrankShowConfig::shared_config();
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set PRANK_SHOW_TEST_POST_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function post_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("PRANK_SHOW_TEST_POST_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["PRANK_SHOW_TEST_POST_ENTID"]);
