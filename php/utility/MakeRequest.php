...
// PrankShow SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PrankShowMakeRequest
{
    public static function call(PrankShowContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PrankShowResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PrankShowResponse($fetched);
        } else {
