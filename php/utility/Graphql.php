...
class PrankShowGraphql
{
    ...
    // equivalent.
    public static function body(PrankShowContext $ctx): mixed
    {
    ...
    public static function errors(PrankShowContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
