...
class PrankShowFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PrankShowSDK/1.0)';
    ...
    public static function call(PrankShowContext $ctx, string $fullurl, array $fetchdef): array
    {
