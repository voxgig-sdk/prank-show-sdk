...
// PrankShow SDK clienttrack feature
...
class PrankShowClienttrackFeature extends PrankShowBaseFeature
{
    ...
    public function PostConstruct(PrankShowContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PrankShow-SDK';
