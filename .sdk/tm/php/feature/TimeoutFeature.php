...
class PrankShowTimeoutFeature extends PrankShowBaseFeature
{
    ...
    private function _with_timeout(PrankShowContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PrankShowContext $_ctx, float $ms): void
    {
        $client = $this->client;
