...
class PrankShowProxyFeature extends PrankShowBaseFeature
{
    ...
    public function init(PrankShowContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PrankShowContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
