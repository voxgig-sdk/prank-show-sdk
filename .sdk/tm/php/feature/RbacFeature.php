...
class PrankShowRbacFeature extends PrankShowBaseFeature
{
    ...
    private function _required(PrankShowContext $ctx): ?string
    {
    ...
    private function _reject(PrankShowContext $ctx, string $required): void
    {
    ...
    private function _track(PrankShowContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
