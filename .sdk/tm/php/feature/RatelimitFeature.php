...
// PrankShow SDK ratelimit feature
...
class PrankShowRatelimitFeature extends PrankShowBaseFeature
{
    ...
    private function _acquire(PrankShowContext $ctx): void
    {
    ...
    private function _track(PrankShowContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
