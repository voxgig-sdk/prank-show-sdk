...
// PrankShow SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PrankShowTestFeature extends PrankShowBaseFeature
{
    ...
    public function init(PrankShowContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PrankShowContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = PrankShowParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PrankShowContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PrankShowContext $ctx, $op, $args): array
    {
