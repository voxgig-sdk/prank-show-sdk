...
class PrankShowNetsimFeature extends PrankShowBaseFeature
{
    ...
    private function _simulate(PrankShowContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PrankShowContext $ctx, array $applied): void
    {
        $client = $this->client;
