...
class PrankShowTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PrankShowTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = PrankShowTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = PrankShowTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
