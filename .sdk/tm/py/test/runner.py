...
class PrankShowTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PrankShowTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = PrankShowTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = PrankShowTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
