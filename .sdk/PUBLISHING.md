...
|---|---|---|
| `ts/` | @voxgig-sdk/prank-show-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/prank-show-sdk \
      --repository voxgig-sdk/prank-show-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/prank-show-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/prank-show-sdk --id=<id>` removes one.
